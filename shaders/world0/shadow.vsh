...
void main() {
	...
	shadowSpacePos = shadowModelViewInverse * shadowProjectionInverse * gl_Position;


	vec4 position      = shadowSpacePos;
	...
	if (mc_Entity.x == 20 || mc_Entity.x == 102 || mc_Entity.x == 95 || mc_Entity.x == 160)
	{
		isStainedGlass = 1.0f;
	}
